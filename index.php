       ...
       <div class="about-body">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <p>On Minecraft.ga, you get access to almost every command that is part of Minecraft, Bukkit and Essentials. Besides from this, you can also use a few Server Plugins, like WorldEdit, Tim the Enchanter and iDisguise, whenever you want. Some commands are blocked, such as /ban, /kick, /jail and /vanish, but this is simply to give you a more enjoyable experience, as well as more security.</p>
                <p>You can choose between four different worlds on Minecraft.ga; Normal, Flat, Nether and The End. Every world resets once every week, to give you a fresh start and a less laggy experience on the server.</p>
            </div>
        </div>
      </div>
    </section>
